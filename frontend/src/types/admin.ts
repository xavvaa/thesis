...
export type AdminTab = 'overview' | 'employer-verification' | 'job-postings' | 'employers' | 'jobseekers' | 'skills-analytics' | 'generate-reports' | 'admin-management' | 'settings' | 'analytics' | 'jobs' | 'users' | 'admins' | 'reports';
